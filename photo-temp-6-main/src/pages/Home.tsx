    ...
    <div className="pt-24 md:pt-32">
      ...
      <section className="px-6 md:px-12 py-8 md:py-24 relative overflow-hidden">
        <div className="max-w-screen-2xl mx-auto flex flex-col-reverse lg:grid lg:grid-cols-12 gap-12 lg:items-center">
          <div className="lg:col-span-8 z-10 transition-all">
            ...
            >
              <span className="text-[9px] md:text-[10px] uppercase tracking-[0.5em] font-bold text-luxury-gold mb-6 md:mb-8 block">
                Visual Storyteller — Based in NY
              </span>
              <h1 className="text-dynamic font-serif select-none mb-8 md:mb-12">
                ...
                <span className="font-italic text-luxury-blue md:pl-24">STORIES</span>
              </h1>
            </motion.div>
            ...
            >
              ...
              <p className="max-w-xs text-[13px] md:text-sm text-luxury-ink/60 leading-relaxed font-light">
                Redefining the art of photography through cinematic composition. Featured in Vogue & Muse.
              </p>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-4 relative mb-8 lg:mb-0">
            ...
            >
              <motion.img 
                src="https://picsum.photos/seed/fashion-hero/1200/1600" 
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 -left-6 md:-bottom-10 md:-left-10 w-24 h-24 md:w-40 md:h-40 border border-luxury-gold/30 rounded-full flex items-center justify-center pointer-events-none bg-luxury-bg/20 backdrop-blur-sm"
            >
      ...
      <section className="py-32 px-6 md:px-12 bg-luxury-surface">
        <div className="max-w-screen-2xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-24 gap-12">
            ...
            <button className="flex items-center gap-4 pb-4 border-b border-luxury-dark group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            >
              <div className="overflow-hidden rounded-xl aspect-[16/9] mb-8">
                <img 
                  src="https://picsum.photos/seed/editorial-1/1600/900" 
                  alt="Velvet Dream" 
                  referrerPolicy="no-referrer"
              ...
              <div className="flex justify-between items-start">
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-luxury-gold font-bold mb-2 block">Editorial — Milan</span>
                  <h3 className="text-3xl font-serif">Velvet Dream</h3>
                </div>
            ...
            <motion.div 
              ...
              className="md:col-span-5 pt-24 group cursor-pointer"
            >
              <div className="overflow-hidden rounded-xl aspect-[3/4] mb-8">
                <img 
                  src="https://picsum.photos/seed/editorial-2/1200/1600" 
                  alt="Noir Elegance" 
                  referrerPolicy="no-referrer"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
                />
              ...
              <div className="flex justify-between items-start">
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-luxury-blue font-bold mb-2 block">Campaign — Paris</span>
                  <h3 className="text-3xl font-serif">Noir Elegance</h3>
                </div>
            ...
            >
              <div className="overflow-hidden rounded-xl aspect-[4/5] mb-8">
                <img 
                  src="https://picsum.photos/seed/editorial-3/1200/1500" 
                  alt="Azure Horizon" 
                  referrerPolicy="no-referrer"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
                />
              ...
              <div className="flex justify-between items-start">
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-luxury-crimson font-bold mb-2 block">Concept — London</span>
                  <h3 className="text-3xl font-serif">Azure Horizon</h3>
                </div>
            ...
            >
              <div className="overflow-hidden rounded-xl aspect-[21/9] mb-8">
                <img 
                  src="https://picsum.photos/seed/editorial-4/1920/820" 
                  alt="The Glass House" 
                  referrerPolicy="no-referrer"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
                />
              ...
              <div className="flex justify-between items-start">
                <div>
                  <span className="text-[10px] uppercase tracking-widest text-luxury-gold font-bold mb-2 block">Architecture — NY</span>
                  <h3 className="text-3xl font-serif">The Glass House</h3>
                </div>
      ...
      <section className="py-48 px-6 md:px-12 bg-luxury-dark text-white text-center overflow-hidden">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h3 className="text-[8vw] md:text-[5vw] font-serif leading-tight mb-12">
              "WE DON'T JUST <span className="text-luxury-gold italic">OBSERVE</span> LIFE. WE <span className="text-luxury-crimson underline underline-offset-8">CREATE</span> IT."
            </h3>
            <p className="text-white/40 uppercase tracking-[0.4em] text-xs mb-16">
              The Creative Philosophy of Aurelius Studio
            </p>
